            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="form-group{{ $errors->has('number') ? ' has-error' : '' }}">
                        <input name="number" type="numeric" class="form-control" id="subject" placeholder="08012345678"  required="" value="{{ old('number')}}">
                        <small class="text-danger">{{ $errors->first('number') }}</small>
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="form-group{{ $errors->has('comments') ? ' has-error' : '' }}">
                        <textarea name="comments" id="comments" rows="4" class="form-control" placeholder="Your comments..." required=""  value="{{ old('comments')}}"></textarea>
